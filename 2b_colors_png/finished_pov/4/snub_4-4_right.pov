...
#declare RedFaces = array[4]{array[4]{6, 3, 0, 6}, array[4]{1, 2, 5, 1}, array[4]{4, 8, 10, 4}, array[4]{11, 9, 7, 11}};

#declare YellowFaces = array[4]{array[4]{1, 7, 3, 1}, array[4]{9, 6, 10, 9}, array[4]{4, 2, 0, 4}, array[4]{11, 8, 5, 11}};
