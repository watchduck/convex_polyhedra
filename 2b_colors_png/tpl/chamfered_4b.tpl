...
#declare UncoloredEdges = array[24]{array[2]{9, 14}, array[2]{12, 15}, array[2]{13, 14}, array[2]{2, 4}, array[2]{0, 6}, array[2]{3, 5}, array[2]{10, 11}, array[2]{0, 2}, array[2]{5, 7}, array[2]{8, 11}, array[2]{4, 5}, array[2]{9, 13}, array[2]{0, 1}, array[2]{7, 15}, array[2]{3, 7}, array[2]{11, 12}, array[2]{10, 13}, array[2]{1, 8}, array[2]{8, 12}, array[2]{6, 10}, array[2]{1, 3}, array[2]{2, 6}, array[2]{4, 9}, array[2]{14, 15}};

#declare YellowFaces = array[4]{array[4]{6, 2, 0, 6}, array[4]{14, 13, 9, 14}, array[4]{12, 11, 8, 12}, array[4]{7, 3, 5, 7}};

#declare BlueFaces = array[6]{array[7]{9, 13, 10, 6, 2, 4, 9}, array[7]{3, 7, 15, 12, 8, 1, 3}, array[7]{14, 9, 4, 5, 7, 15, 14}, array[7]{0, 2, 4, 5, 3, 1, 0}, array[7]{10, 13, 14, 15, 12, 11, 10}, array[7]{10, 6, 0, 1, 8, 11, 10}};
