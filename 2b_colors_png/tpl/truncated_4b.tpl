...
#declare BlueEdges = array[6]{array[2]{5, 9}, array[2]{4, 7}, array[2]{3, 8}, array[2]{10, 11}, array[2]{0, 1}, array[2]{2, 6}};

#declare UncoloredEdges = array[12]{array[2]{1, 5}, array[2]{6, 7}, array[2]{4, 5}, array[2]{1, 4}, array[2]{7, 10}, array[2]{2, 3}, array[2]{6, 10}, array[2]{8, 11}, array[2]{0, 2}, array[2]{9, 11}, array[2]{8, 9}, array[2]{0, 3}};

#declare RedFaces = array[4]{array[4]{2, 3, 0, 2}, array[4]{1, 4, 5, 1}, array[4]{6, 7, 10, 6}, array[4]{11, 9, 8, 11}};

#declare YellowFaces = array[4]{array[7]{11, 9, 5, 4, 7, 10, 11}, array[7]{3, 2, 6, 10, 11, 8, 3}, array[7]{2, 6, 7, 4, 1, 0, 2}, array[7]{8, 9, 5, 1, 0, 3, 8}};
